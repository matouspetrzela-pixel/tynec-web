...
const heroQuickNavGhost =
  'inline-flex min-h-[3.3rem] w-full items-center justify-center gap-1 rounded-xl border border-white/60 bg-white/[0.18] px-2.5 py-3 text-center text-[clamp(0.8125rem,1.75vw,0.9375rem)] font-bold uppercase tracking-[0.1em] text-white shadow-[0_2px_10px_rgba(0,0,0,0.18)] ring-1 ring-inset ring-white/18 backdrop-blur-sm transition-all duration-200 hover:scale-[1.02] hover:border-white/75 hover:bg-white/[0.26] hover:shadow-[0_6px_20px_rgba(0,0,0,0.22)] active:scale-[0.99] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-white';

const heroQuickNavPrimary =
  'btn-primary-sheen inline-flex min-h-[3.9rem] w-full items-center justify-center rounded-xl px-4 py-4 text-center text-[clamp(0.875rem,1.9vw,1rem)] font-bold uppercase tracking-[0.1em] shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-transform duration-200 hover:scale-[1.02] active:scale-[0.99] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-white';
...
export const HeroLead: React.FC = () => {
  return (
    <div className="relative min-w-0 overflow-hidden">
      <div className="relative z-[1] flex min-w-0 flex-col gap-[clamp(0.876rem,2.16vw,2.01rem)] px-[clamp(1.07rem,4.12vw,3.61rem)] py-[clamp(1.35rem,3.8vw,4.5rem)] text-left text-white sm:px-[clamp(1.39rem,3.71vw,2.99rem)] lg:px-[clamp(1.75rem,4.02vw,3.61rem)] lg:pt-[clamp(2.52rem,5.77vw,4.79rem)] lg:pb-[clamp(2.21rem,5.15vw,4.33rem)]">
        ...
        <div className="flex w-full flex-col gap-3">
          <CampaignLogo
            variant="hero"
            priority
            className={`block h-auto w-full min-w-0 max-w-[min(100%,clamp(13.9rem,67vw,38rem))] object-contain sm:max-w-[min(100%,clamp(16.7rem,46vw,38rem))] ${logoContrastClass}`}
          />
          <TrackedFacebookOutbound
            href={FACEBOOK_URL}
        ...
        <nav className="flex w-full flex-col gap-2.5" aria-label="Rychlá navigace">
          <TrackedHeroNavLink
            href="/program"
            link_path="/program"
