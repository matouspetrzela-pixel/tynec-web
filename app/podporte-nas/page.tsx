      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <section className="surface-panel p-6 md:p-10">
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start lg:gap-12">
            ...
            <PageSectionHeader
              eyebrow="Zapojte se s námi"
              title="Podpořte nás"
              eyebrowClassName="tracking-[0.18em]"
              ruleClassName="w-12"
              titleClassName="mt-5 font-extrabold leading-[0.98] tracking-[-0.02em]"
              intro="Každá podpora pomáhá. Sledujte kampaň, sdílejte ji a buďte u toho, když rozhodujeme o budoucnosti obce."
            />
            ...
            <aside className="relative rounded-2xl border border-slate-200/85 bg-gradient-to-br from-white to-slate-50/65 p-6 sm:p-7 lg:p-8">
              ...
              <p className="mt-5 text-[length:var(--font-h2-mobile)] font-black leading-[0.9] tracking-tight text-tynec-black md:text-[length:var(--font-h2-desktop)]">
                9.–10.
                <br />
                října 2026
              </p>
